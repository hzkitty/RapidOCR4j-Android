...
public class RapidOCR {
    ...
    public static RapidOCR create(Context context) {
        return new RapidOCR(context);
    }

    public static RapidOCR create(Context context, OcrConfig config) {
        return new RapidOCR(context, config);
    }

    public RapidOCR(Context context) {
        this(context, new OcrConfig());
    }

    public RapidOCR(Context context, OcrConfig config) {
...
//            OpencvLoader.loadOpencvLib();
        ...
        this.textDet = new TextDetector(context, config.getDet());

        this.useCls = globalConfig.isUseCls();
        this.textCls = new TextClassifier(context, config.getCls());
    ...
    public OcrResult run(Bitmap image) throws Exception {
    ...
    public OcrResult run(Bitmap image, ParamConfig paramConfig) throws Exception {
